...
<div class="m-3">
    <button id="add-new-glaze" type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-add-edit-glaze" data-reload-page="true">&plus; Add a new glaze</button>
</div>
